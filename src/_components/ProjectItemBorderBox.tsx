...
const ProjectItemBorderBox = memo(({ imagePath, imageWidth, imageHeight, isPriority, title, githubLink }: ProjectItemBorderBoxProps) => {
    return (
        <div className='border border-mediumGrey rounded-3xl text-center p-6 flex flex-col gap-y-8'>
            <ImageWithLoader src={imagePath} alt={title} width={imageWidth} isPriority={isPriority} height={imageHeight} borderRadius='rounded-3xl' className='flex-1 aspect-video' />
